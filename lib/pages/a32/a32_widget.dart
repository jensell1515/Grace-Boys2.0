...
import 'a32_model.dart';
export 'a32_model.dart';

class A32Widget extends StatefulWidget {
  const A32Widget({Key? key}) : super(key: key);

  @override
  _A32WidgetState createState() => _A32WidgetState();
}

class _A32WidgetState extends State<A32Widget> {
  late A32Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => A32Model());
  }
