...
import 'a53_model.dart';
export 'a53_model.dart';

class A53Widget extends StatefulWidget {
  const A53Widget({Key? key}) : super(key: key);

  @override
  _A53WidgetState createState() => _A53WidgetState();
}

class _A53WidgetState extends State<A53Widget> {
  late A53Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => A53Model());
  }
                ...
                child: Row(
                  ...
                  children: [
                    Container(
                      ...
                      child: Image.asset(
                        'assets/images/Diseo_sin_ttulo_(30).png',
                        fit: BoxFit.cover,
                      ),
                    ),
                  ],
