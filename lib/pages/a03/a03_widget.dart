...
import 'a03_model.dart';
export 'a03_model.dart';

class A03Widget extends StatefulWidget {
  const A03Widget({Key? key}) : super(key: key);

  @override
  _A03WidgetState createState() => _A03WidgetState();
}

class _A03WidgetState extends State<A03Widget> {
  late A03Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => A03Model());
  }
        ...
        body: SafeArea(
          ...
          child: Column(
            ...
            children: [
                ...
                children: [
                  Flexible(
                    child: Padding(
                      ...
                      child: Text(
                        'El alivio de la ansiedad y los ataques de pánico al alcance de tu bolsillo ',
                ...
                child: Row(
                  ...
                  children: [
                    Container(
                      ...
                      child: Image.asset(
                        'assets/images/Diseo_sin_ttulo_(35).png',
                        fit: BoxFit.cover,
                      ),
                    ),
                  ],
              ...
              Padding(
                padding: EdgeInsetsDirectional.fromSTEB(0.0, 53.0, 0.0, 0.0),
                child: Row(
                  mainAxisSize: MainAxisSize.max,
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
