...
import 'a39_model.dart';
export 'a39_model.dart';

class A39Widget extends StatefulWidget {
  const A39Widget({Key? key}) : super(key: key);

  @override
  _A39WidgetState createState() => _A39WidgetState();
}

class _A39WidgetState extends State<A39Widget> {
  late A39Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => A39Model());
  }
                            ...
                            Row(
                              ...
                              children: [
                                Align(
                                  ...
                                  child: Text(
                                    '¿Qué es el  Tratorno de espectro Autista?',
