...
import 'a20_model.dart';
export 'a20_model.dart';

class A20Widget extends StatefulWidget {
  const A20Widget({Key? key}) : super(key: key);

  @override
  _A20WidgetState createState() => _A20WidgetState();
}

class _A20WidgetState extends State<A20Widget> {
  late A20Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => A20Model());
  }
