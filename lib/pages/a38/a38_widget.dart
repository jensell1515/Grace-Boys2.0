...
import 'a38_model.dart';
export 'a38_model.dart';

class A38Widget extends StatefulWidget {
  const A38Widget({Key? key}) : super(key: key);

  @override
  _A38WidgetState createState() => _A38WidgetState();
}

class _A38WidgetState extends State<A38Widget> {
  late A38Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => A38Model());
  }
