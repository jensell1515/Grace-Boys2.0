...
import 'a44_model.dart';
export 'a44_model.dart';

class A44Widget extends StatefulWidget {
  const A44Widget({Key? key}) : super(key: key);

  @override
  _A44WidgetState createState() => _A44WidgetState();
}

class _A44WidgetState extends State<A44Widget> {
  late A44Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => A44Model());
  }
