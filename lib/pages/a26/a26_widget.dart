...
import 'a26_model.dart';
export 'a26_model.dart';

class A26Widget extends StatefulWidget {
  const A26Widget({Key? key}) : super(key: key);

  @override
  _A26WidgetState createState() => _A26WidgetState();
}

class _A26WidgetState extends State<A26Widget> {
  late A26Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => A26Model());
  }
