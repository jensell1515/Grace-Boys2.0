...
import 'a66_model.dart';
export 'a66_model.dart';

class A66Widget extends StatefulWidget {
  const A66Widget({Key? key}) : super(key: key);

  @override
  _A66WidgetState createState() => _A66WidgetState();
}

class _A66WidgetState extends State<A66Widget> {
  late A66Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => A66Model());
  }
                              ...
                              Flexible(
                                child: Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      5.0, 3.0, 8.0, 0.0),
                                  child: Text(
                                    ' Catarsis tiene insomnio, con esta melodía puedes ayudarla a dormir ',
                                    textAlign: TextAlign.center,
                                    style: FlutterFlowTheme.of(context)
                                        .titleSmall
                                        .override(
