...
import 'a31_model.dart';
export 'a31_model.dart';

class A31Widget extends StatefulWidget {
  const A31Widget({Key? key}) : super(key: key);

  @override
  _A31WidgetState createState() => _A31WidgetState();
}

class _A31WidgetState extends State<A31Widget> {
  late A31Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => A31Model());
  }
